import xlrd
# from common.util import projectpath
class ExcelUtil:
...
if __name__ == "__main__":
    # pass
    dep = {'casename': None, 'replace': '$.code'}
    print(None in dep.values())
    # path =projectpath()+"data\\"+"testdata.xlsx"
    # ex = ExcelUtil(r"D:\selenium\py\lesson05\testdata.xlsx","role")
